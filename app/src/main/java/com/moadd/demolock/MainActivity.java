...
import com.moadd.demolock.Fragments.AllLocks;
import com.moadd.demolock.Fragments.AllMachines;
import com.moadd.demolock.Fragments.HomeFragment;
import com.moadd.demolock.Fragments.Synchronize;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createMenuOption() {
        ...
        drawerItem[0] = new DataModel(R.mipmap.synchronization_button_with_two_arrows, "Synchronize");
        drawerItem[1] = new DataModel(R.mipmap.machine, "Machines");
        drawerItem[2] = new DataModel(R.drawable.locks, "Locks");
        drawerItem[3] = new DataModel(R.drawable.ic_home_black_24dp, "Lock Settings");
